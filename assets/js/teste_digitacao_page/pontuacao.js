export class Pontuacao {
    ...
    mostrarPontuacao() {
        ...
        const botao = this.ui.criarBotao('botao-reniciar-teste', 'Reniciar') // Cria um botão para reiniciar o teste
        ...
        pontuacaoContentDiv.appendChild(botao) // Adiciona o botão "Reiniciar" à div de conteúdo da pontuação
